...
?>
	        ...
	        <div class="container constrained light border-top">
                <div class="row">
                	...
                	<p>Take snapshots as you go of your inspirations, ideas, sketches, drafts, and final work, or document the steps you took in a finished project. Upload pictures, write notes, and add things like URLs and keyword tags to document the steps of your creative process. </p>
                </div>
            </div>
            <div class="container constrained light border-top">
                <div class="row">
                	...
                	<p>Connect your artifacts to show how your ideas evolve over time. Show how an idea evolved into a sketch, or how a draft came from an inspiration. After adding connections, Bloomcase then automatically creates a dynamic relational process map out of your materials that show how your ideas evolved over time.

                       <!--  For example, if you saw a movie and it inspired you to come up with a new idea for a story, add an "inspiration" artifact to document the movie you saw and connect it to an "idea" artifact that talks about the idea you had after seeing the movie. -->  </p>
                </div>
            </div>
            <div class="container constrained light border-top">
                <div class="row">
