					<div id="project-menu" class="">
                        <ul class="menu">
                            <li><a href="<?php print $pathPrefix; ?>profile/projects/project-name" data-title="Story Mode" class="active"><img class="icon-story-mode" src="<?php print $pathPrefix; ?>img/icon-story-mode.png" alt="Story Mode" width="30" height="30" /></a></li>
                            ...
                            <li><a href="<?php print $pathPrefix; ?>profile/projects/project-name/blog" data-title="Blog Mode"><img class="icon-blog-mode" src="<?php print $pathPrefix; ?>img/icon-blog-mode.png" alt="Blog Mode" width="30" height="30" /></a></li>
